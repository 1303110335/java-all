...
//        CtClass interface1 = pool.get("com.foo.proxy.TicketService");
        CtClass interface1 = pool.get("com.redis.example.demo.dynamicproxy.javassist.TicketService");
        cc.setInterfaces(new CtClass[]{interface1});

        //设置Field
        CtField field = CtField.make("private com.redis.example.demo.dynamicproxy.javassist.Station station;", cc);

        cc.addField(field);

        CtClass stationClass = pool.get("com.redis.example.demo.dynamicproxy.javassist.Station");
