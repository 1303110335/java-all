...
import com.redis.example.demo.encrypt.encryptTypeImpl.HexUtil;
...
//		rsaHexTest();
        ...
        // A125686DFF14BB2AAD0721D5E6E61F65
        // 7AB430C9995BC6F754439879B7E176FF
        // 0387B6D86E00AF8596F7CB70F9797BE6
//        getKey(key);
    }
    ...
    public static Key getKey(String strKey) throws Exception {
        ...
        System.out.println("生成密钥:" + HexUtil.byteArrayToHexStr(getKey.getEncoded()) + "----" + HexUtil.byteArrayToHexStr(getKey.getEncoded()).length());
        return getKey;
    }
